...
git clone -b v1.3.1 --filter=blob:none --depth 1 https://github.com/madler/zlib.git
git clone -b v1.6.40 --filter=blob:none --depth 1 https://github.com/glennrp/libpng.git
