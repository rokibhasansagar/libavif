...
git clone -b v1.14.0 --filter=blob:none --depth 1 https://github.com/google/googletest.git
cd googletest
mkdir build
cd build
...
cmake .. -G Ninja -DBUILD_SHARED_LIBS=OFF -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DCMAKE_BUILD_TYPE=Release -DBUILD_GMOCK=OFF -Dgtest_force_shared_crt=ON -Wno-dev
cd ../..
