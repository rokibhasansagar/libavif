...
git clone -b 3.0.3 --filter=blob:none --depth 1 https://github.com/libjpeg-turbo/libjpeg-turbo.git
...
#
#     WITH_CRT_DLL
cmake -S libjpeg-turbo -B libjpeg-turbo/build.libavif -G Ninja -DENABLE_SHARED=OFF -DENABLE_STATIC=ON -DCMAKE_BUILD_TYPE=Release -DWITH_TURBOJPEG=OFF -DWITH_CRT_DLL=ON -Wno-dev
